...
const Home = () => {
    ...
    return (
        <div className='justify-around mt-40 mx-20'>
            <div>
                ...
                <h2 className='text-2xl text-gray-500 mt-10'>Here in this website you can see there are a lot of question and ans
